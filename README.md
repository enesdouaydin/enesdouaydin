...
- 🤖 Focused on **LLM agents, RAG, applied ML and computer vision** (PyTorch, YOLO) on top of production data pipelines
...
> Ayrıca: **YOLO** (computer vision), **CI/CD** ve **DevOps** pratikleri — devicon'da hazır ikonu olmadığı için listeye eklenmedi, istersen shields.io ile özel rozet de yapabiliriz.
